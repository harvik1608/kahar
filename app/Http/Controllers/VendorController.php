...
class VendorController extends Controller
{
    ...
    {
        $role = 3;
        $users = User::select("id","name","phone","avatar")->where("created_by",Auth::user()->id)->where("role",3)->orderBy("id","desc")->get();
    ...
    public function store(Request $request)
    {
        try {
            ...
            return response()->json(['success' => true,'message' => "Vendor added successfully."], 200);
        } catch (\Exception $e) {
    ...
    public function edit($id)
    {
        ...
        $countries = Country::select("id","name")->where("is_active",1)->orderBy("name","asc")->get();
        return view('admin.vendor.add_edit',compact('admin','countries'));   
    }
    ...
    public function update(Request $request,$id)
    {
        try {
            ...
            return response()->json(['success' => true,'message' => "Vendor edited successfully."], 200);
        } catch (\Exception $e) {
            return response()->json(['success' => false,'message' => $e->getMessage()], 200);
        }
    }
    ...
    public function destroy($id)
    {
        ...
        User::destroy($id);
        return response()->json(['success' => true,'message' => "Vendor removed successfully."], 200);
    }
}
