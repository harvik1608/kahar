						...
						<div class="d-flex align-items-center justify-content-between border-bottom mb-3 pb-3 flex-wrap gap-2">
							<div class="d-flex align-items-center">
								<a href="javascript:void(0);" class="avatar avatar-lg flex-shrink-0">
									<img src="{{ $row->vendor && $row->vendor->avatar != '' ? asset('uploads/admin/'.$row->vendor->avatar) : asset('assets/img/kahar_user.jpg') }}" alt="img">
								</a>
								<div class="ms-2">
									<h6 class="fs-14 fw-bold mb-1"><a href="javascript:void(0);">{{ optional($row->vendor)->name ?? 'N/A' }}</a></h6>
									<div class="d-flex align-items-center item-list">			
										<p class="d-inline-flex align-items-center"><i class="ti ti-fish me-1"></i> &nbsp;{{ $row->fish }} KG. &nbsp;&nbsp;<i class="ti ti-calendar me-1"></i> &nbsp;{{ format_date($row->date) }}</p>
									</div>
								</div>
							</div>
							<div class="text-end">
								<h5>
									<div class="edit-delete-action">
										<a href="{{ url('admin/purchase_entries/'.$row->id.'/edit/') }}" class="me-2 edit-icon p-2 text-success" title="Edit">
											<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit">
		                            			<path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path>
		                            			<path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path>
		                        			</svg>
		                    			</a>
		                    			<a href="javascript:;" onclick="remove_row('{{ url('admin/purchase_entries/' . $row->id) }}')" data-bs-toggle="modal" data-bs-target="#delete-modal" class="p-2" title="Delete">
